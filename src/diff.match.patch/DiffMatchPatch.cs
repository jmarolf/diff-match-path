...
namespace DiffMatchPatch {
    ...
    public class DiffMatchPatch {
        ...
        public List<Diff> Diff(string text1, string text2, bool checklines = true) {
            ...
            int commonlength = ComputeCommonPrefix(text1, text2);
            string commonprefix = text1.Substring(0, commonlength);
            text1 = text1.Substring(commonlength);
            text2 = text2.Substring(commonlength);

            // Trim off common suffix (speedup).
            commonlength = ComputeCommpnSuffix(text1, text2);
            string commonsuffix = text1.Substring(text1.Length - commonlength);
            text1 = text1.Substring(0, text1.Length - commonlength);
            text2 = text2.Substring(0, text2.Length - commonlength);

            // Compute the diff on the middle block.
            diffs = ComputeDiff(text1, text2, checklines);
        ...
        /// </param>
        /// <returns>List of Diff objects.</returns>
        private List<Diff> ComputeDiff(string text1,
                                       string text2,
                                       bool checklines) {
            ...
            string[] hm = ComputeHalfMatch(text1, text2);
            if (hm != null) {
                ...
                List<Diff> diffs_a = Diff(text1_a, text2_a, checklines);
                List<Diff> diffs_b = Diff(text1_b, text2_b, checklines);
                // Merge the results.
                diffs = diffs_a;
            ...
            if (checklines && text1.Length > 100 && text2.Length > 100) {
                return ComputeLineModeDiff(text1, text2);
            }

            return ComputeDiffBisect(text1, text2);
        }
        ...
        /// <param name="text2">New string to be diffed.</param>
        /// <returns>List of Diff objects.</returns>
        private List<Diff> ComputeLineModeDiff(string text1, string text2) {
            // Scan the text on a line-by-line basis first.
            var a = ConvertLinesToCharacters(text1, text2);
            text1 = a.chars1;
            text2 = a.chars2;
            List<string> linearray = a.lineArray;

            List<Diff> diffs = Diff(text1, text2, false);

            // Convert the diff back to original text.
            ConvertCharactersToLines(diffs, linearray);
                ...
                switch (diffs[pointer].operation) {
                    ...
                    case Operation.EQUAL:
                        ...
                        if (count_delete >= 1 && count_insert >= 1) {
                            ...
                            List<Diff> subDiff =
                                this.Diff(text_delete, text_insert, false);
        ...
        /// <param name="text2">New string to be diffed.</param>
        /// <returns>List of Diff objects.</returns>
        protected List<Diff> ComputeDiffBisect(string text1, string text2) {
            ...
            List<Diff> diff_bisectSplit(string text1, string text2, int x, int y) {
                ...
                List<Diff> diffs = Diff(text1a, text2a, false);
                List<Diff> diffsb = Diff(text1b, text2b, false);
        ...
        protected (string chars1, string chars2, List<string> lineArray) ConvertLinesToCharacters(string text1, string text2) {
            ...
            string chars1 = ComputeText(text1, lineArray, lineHash, 40000);
            string chars2 = ComputeText(text2, lineArray, lineHash, 65535);
            return (chars1, chars2, lineArray);

            string ComputeText(string text, List<string> lineArray, Dictionary<string, int> lineHash, int maxLines) {
                int lineStart = 0;
                int lineEnd = -1;
                string line;
        ...
        protected void ConvertCharactersToLines(ICollection<Diff> diffs, IList<string> lineArray) {
            StringBuilder text;
        ...
        public int ComputeCommonPrefix(string text1, string text2) {
        ...
        public int ComputeCommpnSuffix(string text1, string text2) {
            // Performance analysis: https://neil.fraser.name/news/2007/10/09/
            int text1_length = text1.Length;
            int text2_length = text2.Length;
            int n = Math.Min(text1.Length, text2.Length);
        ...
        protected int ComputeCommonOverlap(string text1, string text2) {
            // Cache the text lengths to prevent multiple calls.
            int text1_length = text1.Length;
            int text2_length = text2.Length;
        ...
        protected string[] ComputeHalfMatch(string text1, string text2) {
        ...
        private string[] diff_halfMatchI(string longtext, string shorttext, int i) {
            ...
            while (j < shorttext.Length && (j = shorttext.IndexOf(seed, j + 1,
                ...
                int prefixLength = ComputeCommonPrefix(longtext.Substring(i),
                                                     shorttext.Substring(j));
                int suffixLength = ComputeCommpnSuffix(longtext.Substring(0, i),
            ...
            while (pointer < diffs.Count - 1) {
                if (diffs[pointer - 1].operation == Operation.EQUAL &&
                  diffs[pointer + 1].operation == Operation.EQUAL) {
                    ...
                    int commonOffset = this.ComputeCommpnSuffix(equality1, edit);
                    if (commonOffset > 0) {
                    ...
                    case Operation.EQUAL:
                        ...
                        if (count_delete + count_insert > 1) {
                            if (count_delete != 0 && count_insert != 0) {
                                ...
                                commonlength = this.ComputeCommonPrefix(text_insert, text_delete);
                                if (commonlength != 0) {
                                ...
                                commonlength = this.ComputeCommpnSuffix(text_insert, text_delete);
                                if (commonlength != 0) {
        ...
        public List<Patch> patch_make(string text1, string text2) {
            ...
            List<Diff> diffs = Diff(text1, text2, true);
            if (diffs.Count > 2) {
                diff_cleanupSemantic(diffs);
